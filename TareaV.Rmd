...
Se tomaron los datos de la inflación y del desempleo de las bases de datos del INEGI, y la tasa de interés a corto plazo del Banco de México.  Es importante señalar que los datos sobre desocupación se tomaron de muestras urbanas de los 32 estados de la república, pues antes de 2005 la ENOE no se realizaba de forma general en el país. Por otro lado, para la tasa de interés a corto plazo se usaron los datos de CETES 28. Finalmente, cabe añadir que se tomó el promedio de la inflación mensual para obtener los datos de cada año.
```{r, warning=FALSE}
